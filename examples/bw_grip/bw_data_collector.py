...
from bw_gt_state_estimator import (pddl_id_to_mujoco_entity, pddl_id_to_mujoco_name, ITEM_PDDL_IDS,
...
def main():
    ...
    exec = BlocksWorldSkillExecuter(env, pddl_id_to_mujoco_name, pddl_id_to_mujoco_entity, ITEM_PDDL_IDS)
