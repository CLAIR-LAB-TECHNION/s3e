...
RENDER_CAMS = ['frontview', 'rightangleview', 'leftangleview']
# RENDER_CAMS = ['frontview', 'rightsideview', 'leftsideview']


def main(run_name, task_horizon, set_goal_cond, se_class, **se_kwargs):
    env = get_env()
    ...
    runner = EpisodeRunner(
        ...
        set_goal_condition=set_goal_cond, planner='pyperplan'
    )
